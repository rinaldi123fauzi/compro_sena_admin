                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ route('header.capability_update') }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="header_capability_text_en"
                                        name="header_capability_text_en"
                                        value="{{ old('header_capability_text', $header->header_capability_text_en) }}">
                                    @error('header_capability_text_en')
                                        <div class="error-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror

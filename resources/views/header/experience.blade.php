                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="header_experience_text_en"
                                        name="header_experience_text_en"
                                        value="{{ old('header_experience_text', $header->header_experience_text_en) }}">
                                    @error('header_experience_text_en')
                                        <div class="error-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror

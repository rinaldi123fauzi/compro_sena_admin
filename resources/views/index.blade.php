                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 overflow-hidden">
                                                <p class="text-uppercase fw-bold text-white-50 text-truncate mb-0">Total
                                                    Earnings</p>
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-animate bg-info">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 overflow-hidden">
                                                <p class="text-uppercase fw-bold text-white-50 text-truncate mb-0">My
                                                    Balance</p>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <h5 class="text-white fs-14 mb-0">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                ...
                                                <a href=""
                                                    class="text-decoration-underline text-white-50">Withdraw money</a>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                                <span class="avatar-title bg-soft-light rounded fs-3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="fs-14 my-1 fw-normal"><span
                                                                    class="badge badge-soft-danger">Out of stock</span>
                                                            </h5>
                                                            <span class="text-muted">Stock</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="fs-14 fw-medium mb-0">5.0<span
                                                                    class="text-muted fs-13 ms-1">(61 votes)</span>
                                                            </h5>
                                                        </td>
                                                    </tr><!-- end tr -->
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="fs-14 fw-medium mb-0">4.9<span
                                                                    class="text-muted fs-13 ms-1">(89 votes)</span>
                                                            </h5>
                                                        </td>
                                                    </tr><!-- end tr -->
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="fs-14 fw-medium mb-0">4.3<span
                                                                    class="text-muted fs-13 ms-1">(47 votes)</span>
                                                            </h5>
                                                        </td>
                                                    </tr><!-- end tr -->
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="fs-14 fw-medium mb-0">4.7<span
                                                                    class="text-muted fs-13 ms-1">(161 votes)</span>
                                                            </h5>
                                                        </td>
                                                    </tr><!-- end tr -->
                                                </tbody><!-- end tbody -->
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="text-center">
                                        <div class="text-muted">Total <span class="fw-semibold">5.50k</span>reviews
                                        </div>
                                    </div>

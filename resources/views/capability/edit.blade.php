            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Capability</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST"
                                action="{{ route('capability.update', $capability->id) }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" id="title" value="{{ old('title', $capability->title) }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                        rows="8">{{ old('description', $capability->description) }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($capability->icon)
                                        <div class="mb-2">
                                            <img src="{{ $capability->icon_url }}" alt="Current Icon"
                                                class="img-thumbnail" style="max-width: 100px;">
                                            <p class="text-muted mt-1">Icon saat ini: {{ $capability->icon }}</p>
                                        </div>
                                    @endif

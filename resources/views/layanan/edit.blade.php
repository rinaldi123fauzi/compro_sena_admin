            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Layanan - {{ $capability->title }}</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST"
                                action="{{ route('layanan.update', [$capability->id, $layanan->id]) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" id="title" value="{{ old('title', $layanan->title) }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                        rows="8">{{ old('description', $layanan->description) }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" name="type"
                                        ...
                                        <option value="During Construction"
                                            {{ old('type', $layanan->type) == 'During Construction' ? 'selected' : '' }}>
                                            Pre Construction</option>
                                        <option value="Post Operation"
                                            {{ old('type', $layanan->type) == 'Post Operation' ? 'selected' : '' }}>
                                            Post Operation</option>
                                        <option value="Other"
                                            {{ old('type', $layanan->type) == 'Other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>

                                            ...
                                            <div id="accor_fill22" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-md-12" style="margin-top:15px">
                                                        ...
                                                        <textarea id="editor1" name="content_en">{{ $news->title }}</textarea>
                                                    ...
                                                    <div class="col-md-12" style="margin-top:15px">
                                                        ...
                                                        <input type="text" class="form-control" id="seo_title_en"
                                                            name="seo_title_en"
                                                            value="{{ old('seo_title_en', $news->title) }}">
                                                    ...
                                                    <div class="col-md-12" style="margin-top:15px">
                                                        <label for="validationDefault01" class="form-label">SEO - Meta
                                                            Description</label>
                                                        <textarea type="text" class="form-control" name="seo_description_en">{{ old('seo_description_en', $news->seo_description_en) }}</textarea>
